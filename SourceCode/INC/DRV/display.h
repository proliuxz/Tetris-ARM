...
//定义各种方块的颜色和背景色以及前景色（目前只能显示红白黑三种颜色）
#define DARKGRAY 0xFCCCCCC             	//灰
#define WHITE    0xFFFFFFF             	//白
#define GREEN    0xF00CD00				//绿	
#define BLACK    0xF000000				//黑
#define YELLOW   0xFEEEE00	   			//黄
#define CYAN     0xFFF00FF  			//紫
#define MAGENTA  0xFA0522D				//棕	
#define BROWN    0xFD2691E				//褐	
#define RED      0xF0000EE				//红	
#define BLUE     0xFEE0000			    //蓝
